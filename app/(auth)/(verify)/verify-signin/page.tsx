      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          <div className="text-center lg:text-left space-y-4">
            ...
            <h2 className="text-2xl font-bold text-foreground">Verify your identify</h2>
            ...
            <p className="mt-4 text-sm text-muted-foreground">Verification code</p>
            ...
            <div className="text-center text-sm mt-4">
              <span className="text-muted-foreground">Don't receive the code? </span>
